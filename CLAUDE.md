...
The phone app allows for customizing buttons, such as resizing, rearranging, and adding/removing. Users can also create custom shortcuts using a string (ex: "CTRL+ALT+DEL").  -->
